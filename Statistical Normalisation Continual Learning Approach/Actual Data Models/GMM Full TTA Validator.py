...
def TTATester(encoder, classifier, der_buffer,dataLoader, ttaLoader,adaptOpt,gmm):  
    encoder_state_before = copy.deepcopy(encoder.state_dict())
    classifier_state_before = copy.deepcopy(classifier.state_dict())
    
    results = TTA(encoder,classifier,der_buffer,dataLoader, ttaLoader,adaptOpt,gmm)
